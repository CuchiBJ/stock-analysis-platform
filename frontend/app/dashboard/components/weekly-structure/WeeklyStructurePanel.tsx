  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="p-4 border-b border-gray-200">
        <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide">Weekly Structure Panel</h3>
        <p className="text-xs text-gray-500 mt-1">Semanas consolidando, tight weekly closes, volatility contraction</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-3 py-2 text-right font-medium text-gray-600">Weeks in Base</th>
